         ...
         if contains(parentItem, item) then
            ...
            if tk then 
                ...
                if origText ~= "" then
                    ...
                    wwiseSep = " .SEP10. "
                    _,wwisePos = string.find(fullText, wwiseSep)
                    fullText = string.sub(fullText, 1, wwisePos)
                    
                    
                    
                    fullText = fullText..wwiseText
...
if tk then
    ...
    if string.find(default_text, "\n") then
      t={}
      for text in string.gmatch(default_text, "([^".."\n".."]+)") do
            t[#t+1] = text
            
          
      end
      default_text = t[1]--:sub(1, -2)
      default_wwise = t[2]
    end
...
GUI.x, GUI.y, GUI.w, GUI.h = 0, 0, 600, 120
